...
// Written with React.createElement to avoid JSX in a .js file
export const DividerDots = () => React.createElement(
  'div',
  { style: { display: 'flex', alignItems: 'center', gap: 10, margin: '0.5rem 0 1.5rem' } },
  React.createElement('span', { style: { flex: 1, height: 1, background: C.border } }),
  React.createElement('span', { style: { color: C.dot, fontSize: 10, letterSpacing: 6 } }, '◆ ◆ ◆'),
  React.createElement('span', { style: { flex: 1, height: 1, background: C.border } })
)
